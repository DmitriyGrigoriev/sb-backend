# Generated by Django 3.1 on 2021-01-24 16:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('settings', '0004_auto_20210123_1001'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='service',
            name='external_service_code',
            field=models.CharField(blank=True, default='', max_length=50, verbose_name='Внешний Код Услуги'),
        ),
        migrations.AlterField(
            model_name='service',
            name='full_name',
            field=models.CharField(blank=True, default='', max_length=1000, verbose_name='Полное наименование'),
        ),
        migrations.AlterField(
            model_name='service',
            name='unit_price',
            field=djmoney.models.fields.MoneyField(decimal_places=20, default_currency='RUB', max_digits=38, verbose_name='Цена Единицы'),
        ),
        migrations.AlterField(
            model_name='unitofmeasure',
            name='okei_code',
            field=models.CharField(blank=True, default='', max_length=3, verbose_name='Код ОКЕИ'),
        ),
    ]
